...
public class LoginUITest {
    ...
    // Test Case 1: Check the presence of login elements
    @Test
    void testUIElements() {
        // Open the login page
        ...
        WebElement registerLink = driver.findElement(By.cssSelector(".register-link a"));
    ...
    // Simulate login failure with an error message
    @Test
    ...
    // Management login success test
    @Test
    void testLoginSuccess_Management() {
        // Open the login page
        driver.get("http://localhost:8080/cab-service/pages/login.jsp");
        ...
        // Enter valid credentials for management
        emailInput.sendKeys("jane.smith@example.com");
        passwordInput.sendKeys("hashed_password_456");
